...
def save_model(nb, label_encoder, scaler):
    # Save the Naive Bayes model
    joblib.dump(
        nb,
        "ML/WineSnifferDeepNetworkModel/PCAModel/shallowPKLFiles/naive_bayes_model.pkl",
    )
...
def run_naive_bayes():
    ...
    file_path = "src/data_analysis_for_NN/6WinesUntil3009_combinedCleaned.csv"  # Adjust path if necessary
    try:
    ...
    save_model(nb, label_encoder, scaler)
