...
def load_data_from_file(filename="AllSensorsClockWiseOpenValves(25degEnvTemp).csv"):
    try:
...
def save_data_to_file(data, filename="AllSensorsClockWiseOpenValves(25degEnvTemp).csv"):
    ...
    try:
        ...
        if port == "COM4":
            ...
            data_dict = {
                ...
                "MQ135": sensors[2].split(":")[1],  # COM3 A2
                "MQ9": sensors[3].split(":")[1],  # COM3 A3
                "BMPTemperature": sensors[4].split(":")[1],  # COM3 A4
                "Pressure(Pa)": sensors[5].split(":")[1],  # COM3 A5
                "DHTTemperature": sensors[6].split(":")[1],  # COM3 A6
                "Humidity": sensors[7].split(":")[1],  # COM3 A7
            }
        return data_dict
    except IndexError:
        ...
        while True:
            if ser1.in_waiting > 0 and ser2.in_waiting > 0:
                ...
                if data1 and data2:
                    ...
                    sensor_data["Target"] = "AllSensorsClockWiseOpenValves(25degEnvTemp)"
