...
// float MQSpaceData::limitValue10000(float Sensorvalue)
// {
//     if (Sensorvalue > 10000)
//         (Sensorvalue = 10000);
//     return Sensorvalue;
// }
// float MQSpaceData::limitValue7000(float Sensorvalue)
// {
//     if (Sensorvalue > 7000)
//         (Sensorvalue = 7000);
//     return Sensorvalue;
// }
// float MQSpaceData::limitValue4000(float Sensorvalue)
// {
//     if (Sensorvalue > 4000)
//         (Sensorvalue = 4000);
//     return Sensorvalue;
// }
// float MQSpaceData::limitValue3000(float Sensorvalue)
// {
//     if (Sensorvalue > 3000)
//         (Sensorvalue = 3000);
//     return Sensorvalue;
// }
// float MQSpaceData::limitValue1000(float Sensorvalue)
// {
//     if (Sensorvalue > 1000)
//         (Sensorvalue = 1000);
//     return Sensorvalue;
// }
// float MQSpaceData::limitValue500(float Sensorvalue)
// {
//     if (Sensorvalue > 500)
//         (Sensorvalue = 500);
//     return Sensorvalue;
// }
// float MQSpaceData::limitValue200(float Sensorvalue)
// {
//     if (Sensorvalue > 200)
//         (Sensorvalue = 200);
//     return Sensorvalue;
// }
// float MQSpaceData::limitValue100(float Sensorvalue)
// {
//     if (Sensorvalue > 100)
//         (Sensorvalue = 100);
//     return Sensorvalue;
...
// float MQSpaceData::MQ2DataLPG()
// {
//     _va = 17.6135;
//     _vb = -0.4539;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ2DataPropane()
// {
//     _va = 19.5575;
//     _vb = -0.461;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ2DataH2()
// {
//     _va = 25.7473;
//     _vb = -0.4731;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ2DataAlcohol()
// {
//     _va = 19.2641;
//     _vb = -0.3604;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ2DataCH4()
// {
//     _va = 20.7074;
//     _vb = -0.36;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ2Datasmoke()
// {
//     _va = 26.4698;
//     _vb = -0.3876;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ2DataCO()
// {
//     _va = 28.024;
//     _vb = -0.3182;
//     return limitValue10000(readValue());
...
// float MQSpaceData::MQ3DataAlcohol()
// {
//     _va = 0.5565;
//     _vb = -0.6333;
//     return limitValue500(readValue());
// }
// float MQSpaceData::MQ3DataBenzene()
// {
//     _va = 1.7957;
//     _vb = -0.369;
//     return limitValue500(readValue());
// }
// float MQSpaceData::MQ3DataHexane()
// {
//     _va = 22.9337;
//     _vb = -0.358;
//     return limitValue500(readValue());
// }
// float MQSpaceData::MQ3DataLPG()
// {
//     _va = 27.8286;
//     _vb = -0.2847;
//     return limitValue500(readValue());
// }
// float MQSpaceData::MQ3DataCO()
// {
//     _va = 31.9559;
//     _vb = -0.2325;
//     return limitValue500(readValue());
// }
// float MQSpaceData::MQ3DataCH4()
// {
//     _va = 44.8389;
//     _vb = -0.0476;
//     return limitValue500(readValue());
...
// float MQSpaceData::MQ4DataCH4()
// {
//     _va = 11.6605;
//     _vb = -0.3558;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ4DataLPG()
// {
//     _va = 13.9134;
//     _vb = -0.3186;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ4DataH2()
// {
//     _va = 9.6559;
//     _vb = -0.1765;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ4DataSmoke()
// {
//     _va = 7.05;
//     _vb = -0.1065;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ4DataAlcohol()
// {
//     _va = 5.7994;
//     _vb = -0.0696;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ4DataCO()
// {
//     _va = 5.4783;
//     _vb = -0.0492;
//     return limitValue10000(readValue());
...
// float MQSpaceData::MQ5DataLPG()
// {
//     _va = 6.1067;
//     _vb = -0.4102;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ5DataCH4()
// {
//     _va = 6.987;
//     _vb = -0.3777;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ5DataH2()
// {
//     _va = 7.4265;
//     _vb = -0.2847;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ5DataAlcohol()
// {
//     _va = 10.8274;
//     _vb = -0.2104;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ5DataCO()
// {
//     _va = 8.2236;
//     _vb = -0.1492;
//     return limitValue10000(readValue());
...
// float MQSpaceData::MQ6DataLPG()
// {
//     _va = 20.3079;
//     _vb = -0.4349;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ6DataCH4()
// {
//     _va = 22.011;
//     _vb = -0.4029;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ6DataH2()
// {
//     _va = 26.9497;
//     _vb = -0.2956;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ6DataAlcohol()
// {
//     _va = 19.3261;
//     _vb = -0.1655;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ6DataCO()
// {
//     _va = 13.4917;
//     _vb = -0.0777;
//     return limitValue10000(readValue());
...
// float MQSpaceData::MQ7DataH2()
// {
//     _va = 21.1794;
//     _vb = -0.7174;
//     return limitValue4000(readValue());
// }
// float MQSpaceData::MQ7DataCO()
// {
//     _va = 20.89;
//     _vb = -0.6568;
//     return limitValue4000(readValue());
// }
// float MQSpaceData::MQ7DataLPG()
// {
//     _va = 14.9745;
//     _vb = -0.1329;
//     return limitValue4000(readValue());
// }
// float MQSpaceData::MQ7DataCH4()
// {
//     _va = 19.8094;
//     _vb = -0.09;
//     return limitValue4000(readValue());
// }
// float MQSpaceData::MQ7DataAlcohol()
// {
//     _va = 20.2524;
//     _vb = -0.0655;
//     return limitValue4000(readValue());
...
// float MQSpaceData::MQ8DataH2()
// {
//     _va = 18391.5667;
//     _vb = -1.4494;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ8DataAlcohol()
// {
//     _va = 468.8045;
//     _vb = -0.5574;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ8DataLPG()
// {
//     _va = 152.1255;
//     _vb = -0.2922;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ8DataCH4()
// {
//     _va = 117.9639;
//     _vb = -0.1448;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ8DataCO()
// {
//     _va = 126.605;
//     _vb = -0.1173;
//     return limitValue10000(readValue());
...
// float MQSpaceData::MQ9DataCO()
// {
//     _va = 17.3985;
//     _vb = -0.4504;
//     return limitValue1000(readValue());
// }
// float MQSpaceData::MQ9DataLPG()
// {
//     _va = 24.918;
//     _vb = -0.4695;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ9DataCH4()
// {
//     _va = 21.8247;
//     _vb = -0.3663;
//     return limitValue10000(readValue());
...
// float MQSpaceData::MQ131DataO3()
// {
//     _va = 16.0871;
//     _vb = -0.8603;
//     return limitValue100(readValue());
// }
// float MQSpaceData::MQ131DataCL2()
// {
//     _va = 18.9693;
//     _vb = -0.7132;
//     return limitValue100(readValue());
// }
// float MQSpaceData::MQ131DataNOx()
// {
//     _va = 16.7059;
//     _vb = -0.4684;
//     return limitValue100(readValue());
...
// float MQSpaceData::MQ135DataAceton()
// {
//     _va = 2.824;
//     _vb = -0.2955;
//     return limitValue200(readValue());
// }
// float MQSpaceData::MQ135DataToluen()
// {
//     _va = 2.9897;
//     _vb = -0.2909;
//     return limitValue200(readValue());
// }
// float MQSpaceData::MQ135DataAlcohol()
// {
//     _va = 3.8776;
//     _vb = -0.3144;
//     return limitValue200(readValue());
// }
// float MQSpaceData::MQ135DataCO2()
// {
//     _va = 5.2146;
//     _vb = -0.3574;
//     return limitValue200(readValue());
// }
// float MQSpaceData::MQ135DataNH4()
// {
//     _va = 6.4416;
//     _vb = -0.3994;
//     return limitValue200(readValue());
// }
// float MQSpaceData::MQ135DataCO()
// {
//     _va = 5.0533;
//     _vb = -0.2541;
//     return limitValue200(readValue());
...
// float MQSpaceData::MQ136DataH2S()
// {
//     _va = 2.7684;
//     _vb = -0.2832;
//     return limitValue200(readValue());
// }
// float MQSpaceData::MQ136DataNH4()
// {
//     _va = 6.4463;
//     _vb = -0.4028;
//     return limitValue200(readValue());
// }
// float MQSpaceData::MQ136DataCO()
// {
//     _va = 5.277;
//     _vb = -0.2622;
//     return limitValue200(readValue());
...
// float MQSpaceData::MQ137DataCO()
// {
//     _va = 5.277;
//     _vb = -0.2622;
//     return limitValue200(readValue());
// }
// float MQSpaceData::MQ137DataEthanol()
// {
//     _va = 6.4463;
//     _vb = -0.4028;
//     return limitValue200(readValue());
// }
// float MQSpaceData::MQ137DataNH3()
// {
//     _va = 2.7684;
//     _vb = -0.2832;
//     return limitValue200(readValue());
...
// float MQSpaceData::MQ303ADataHyd()
// {
//     _va = 1.7955;
//     _vb = -0.3767;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ303ADataEthanol()
// {
//     _va = 1.5196;
//     _vb = -0.367;
//     return limitValue10000(readValue());
// }
// float MQSpaceData::MQ303ADataIso()
// {
//     _va = 1.9209;
//     _vb = -0.3443;
//     return limitValue10000(readValue());
...
// float MQSpaceData::MQ309ADataH2()
// {
//     _va = 44.3713;
//     _vb = -0.5136;
//     return limitValue7000(readValue());
// }
// float MQSpaceData::MQ309ADataCH4()
// {
//     _va = 65.5612;
//     _vb = -0.6033;
//     return limitValue7000(readValue());
// }
// float MQSpaceData::MQ309ADataAlcohol()
// {
//     _va = 34.1956;
//     _vb = -0.2666;
//     return limitValue7000(readValue());
// }
// float MQSpaceData::MQ309ADataCO()
// {
//     _va = 30.3019;
//     _vb = -0.2336;
//     return limitValue7000(readValue());
...
// float MQSpaceData::MQ307ADataCO()
// {
//     _va = 2336.2698;
//     _vb = -1.7255;
//     return limitValue1000(readValue());
// }
// float MQSpaceData::MQ307ADataH2()
// {
//     _va = 25051.8177;
//     _vb = -0.8318;
//     return limitValue3000(readValue());
// }
...
// {
//     if (_cpmcountbool == true)
//         (count = _counts);
//     if (_cpmcountbool == false)
//         (count = 0);
